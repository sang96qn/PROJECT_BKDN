...
#define Wet_Soil_Threshold 50
#define No_Rain_Threshold 900
#define Rain_Threshold 350
...
void check_button()
{
  ...
  switch (_menu)
  {
    ...
    case AGRICULTURE:
        lcd.setCursor(0, 0);
        lcd.print("Level:");
        if(Mass_Percent <=99) {lcd.setCursor(7, 0);
        lcd.print(Mass_Percent);
        lcd.print("%");lcd.print("  ");}
        ...
        lcd.print("Dry Soil !");
          ...
          else if((Wet_Soil_Threshold <= Mass_Percent)&&(Mass_Percent <= Dry_Soil_Threshold))
          {lcd.setCursor(0, 1);
        lcd.print("Oke Soil !");}
          else if(Mass_Percent<Wet_Soil_Threshold) {lcd.setCursor(0, 1);
        lcd.print("Wet Soil !");}
        /*-----------*/
     ...
     lcd.setCursor(14,0);
        lcd.print("No");
         lcd.setCursor(12,1);
        lcd.print("RAIN");  
    } // turn off warning ,it's not rain   
      break;

    case Device_1:
      if (smart == false) {
        if (btn_check == SELECT) { // btn_check = btn_read();
          smart = true;
          healer = btn_check;
        }
        lcd.setCursor(0, 0);
